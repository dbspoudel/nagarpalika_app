            ...
            return InkWell(
              onTap: () {
                Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              DetailsPage(title: main_categories[index].title,)),
                    );
              },
              child: Card(
                elevation: 8.0,
                child: Padding(
                  ...
                  child: Container(
                              ...
                              child: Center(child: Text(main_categories[index].title, style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.normal),),)),
                ),
              ),
            );
          },
